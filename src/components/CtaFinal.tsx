        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-cta hover:bg-cta-600 text-white font-bold text-lg rounded-full shadow-lg shadow-cta/30 hover:shadow-cta/50 transform hover:scale-105 transition-all duration-300 font-body"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-green-500 hover:bg-green-600 text-white font-bold text-lg rounded-full shadow-lg shadow-green-500/30 transition-all duration-300 font-body"
            >
